...
public class Tower_Poison : MonoBehaviour
{
    ParticleSystem m_PosionParticle;
    ...
    float m_AttackSpeed = 15.0f;
    int m_PosionDamage = 1;
    float m_RangeRadius = 10.0f;

    //타워 UpGrade관련 변수
    bool m_UpgradeOnOff = false; //업그레이드OnOff
    [HideInInspector] public int m_TowerValue = 140;   //타워 값어치
    ...
    void Start()
    {
        m_PosionParticle = GetComponentInChildren<ParticleSystem>();
    ...
    void AtPowerUpBtnClick()
    {
        ...
        m_PosionDamage += 1;                     //PosionDamage 증가
    ...
    void SellBtnClick()
    {
        ...
        SlotScript a_Slot = a_TowerInstallMgr.m_TowerSlots[4].GetComponent<SlotScript>();
